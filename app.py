...
st.set_page_config(page_title = 'Email Manager')
...
if EMAIL and PASSWORD:
    ...
    # with open('mail_data.csv') as f:
    #    st.download_button('Download CSV', f, 'csv')
    with open('mail_data.csv', 'rb') as f:
        st.download_button('Download CSV', f, file_name='data.csv')
